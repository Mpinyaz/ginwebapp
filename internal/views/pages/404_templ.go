...
func PageNotFound(message string) templ.Component {
	return templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
		...
		templ_7745c5c3_Var2 := templruntime.GeneratedTemplate(func(templ_7745c5c3_Input templruntime.GeneratedComponentInput) (templ_7745c5c3_Err error) {
			...
			ctx = templ.InitializeContext(ctx)
			templ_7745c5c3_Err = templruntime.WriteString(templ_7745c5c3_Buffer, 1, "<section class=\"min-h-screen flex items-center justify-center bg-gradient-to-br from-orange-400 via-orange-500 to-red-500 px-4 py-12\"><div class=\"max-w-xl w-full text-center bg-white py-8 rounded-lg\"><h1 class=\"text-4xl font-extrabold text-gray-800 dark:text-white mb-4\">Oops! Page Not Found</h1><p class=\"text-lg text-gray-600 dark:text-gray-300 mb-6\">")
			if templ_7745c5c3_Err != nil {
